...
public class Croupier extends Jogador {
    ...
    /**
     * Construtor da classe <b>Croupier</b>, não tem parâmetros, apenas é
     * inicializado o seu usuário e senha.
     */
    public Croupier() {
        super("croupier", "");
    }
    ...
    /**
     * Método para retirar a última carta da pilha de cartas do Baralho, passado
